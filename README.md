...
app/                    --> all of the source files for the application
  ...
  view1/                --> the view1 view template and logic
    ...
    viewAddWorld.js              --> the controller logic
    viewAddWorld_test.js         --> tests of the controller
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    viewWorldPreview.js              --> the controller logic
    viewWorldPreview_test.js         --> tests of the controller
